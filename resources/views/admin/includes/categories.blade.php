                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="text-decoration-none text-dark" href="{{route('categories.destroy',$category->id)}}" onclick="return confirm('are you sure you want to delete?')"><img src="{{asset('assests/images/trash-can-svgrepo-com.svg')}}"></a>
                        </td>
                    </tr>
